package com.hersac.backend.modules.comercial.detallesordenes;
...
public class DetallesOrdenesController {
	...
	private final DetallesOrdenesService detallesOrdenesServ;

	public DetallesOrdenesController(DetallesOrdenesService detallesOrdenesServ) {
		this.detallesOrdenesServ = detallesOrdenesServ;
	}
